...
> 中文版: [01.getting-started.md](../zh/01.getting-started.md)
...
See the template layout in [09.structure.md](./09.structure.md#projecttemplates).
...
With the server up, point any client (the templated C# client, Unity, or TypeScript `npm install goplay-ws`) at it - see [07.clients.md](./07.clients.md).

## What to Read Next

- Terminology and mental model: [03.concepts.md](./03.concepts.md)
- Official performance baseline & tuning tips: [02.performance.md](./02.performance.md)
- Actor model deep-dive: [04.processor-model.md](./04.processor-model.md)
- Swap Transport / Encoder: [05.transport-encoder.md](./05.transport-encoder.md)
- Automate codegen: [06.tools-codegen.md](./06.tools-codegen.md)
- Browser / mini-game clients: [07.clients.md](./07.clients.md)
- Filter / Session / graceful shutdown: [08.advanced.md](./08.advanced.md)
