...
> 中文版: [07.clients.md](../zh/07.clients.md)

GoPlay ships three official clients: C# (desktop, Unity), TypeScript (Web / Node / mini-games), and JavaScript (build-free browser drop-in). All three follow the same wire protocol ([10.protocol.md](./10.protocol.md)); Handshake / Heartbeat / Request / Notify / Push semantics are identical.
...
- Request / Response are correlated by `Id`, see [10.protocol.md](./10.protocol.md).
