...
> 中文版: [08.advanced.md](../zh/08.advanced.md)
...
- Each runner tick consumes up to `maxItems`; leftovers wait for the next tick. See [04.processor-model.md](./04.processor-model.md#broadcast-event-broadcast-across-processors).
