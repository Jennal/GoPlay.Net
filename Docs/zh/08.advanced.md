...
> English version: [08.advanced.md](../en/08.advanced.md)
...
- 每 Runner 每个 tick 最多消费 `maxItems` 条，剩余留下轮；详见 [04.processor-model.md](./04.processor-model.md#broadcastprocessor-间广播事件)。
